...
runner_iact_nonsym_feedback_apply(
  ...
  //const double G0_attenuation = 1.0f;  // unresolved attenuation in birth cloud; free parameter

  //if (si->feedback_data.lum_habing > -10.) {  
    //pj->chemistry_data.G0 += G0_attenuation * fH2_shield * fH_shield * pow(10.,si->feedback_data.lum_habing) / (1.6e-3 * r2_in_cm);
  //}
